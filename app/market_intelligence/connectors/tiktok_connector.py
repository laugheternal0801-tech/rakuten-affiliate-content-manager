...
class TikTokConnector(ManualImportConnector):
    """Approved-provider/manual import adapter; no unsupported scraping fallback."""

    def __init__(self, import_dir: Path | None) -> None:
        super().__init__(SourceName.TIKTOK, import_dir)
